...
textareaField.focus();
// let cursorStart = textareaField.selectionStart; ----- как правильно записать? чтобы курсор работал с того места, куда я его ставлю
// let cursorEnd = textareaField.selectionEnd;
